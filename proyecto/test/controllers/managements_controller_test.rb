...
class ManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create management" do
    assert_difference('Management.count') do
      post managements_url, params: { management: { document_id: @management.document_id, person_id: @management.person_id } }
    end
  ...
  test "should update management" do
    patch management_url(@management), params: { management: { document_id: @management.document_id, person_id: @management.person_id } }
